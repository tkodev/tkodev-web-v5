...
Fast is a feature; the futuristic layer never gets to make the site feel slow.
...
4. **The futuristic layer has a budget.** Entry and loading sequences are capped in duration; motion never blocks interactivity or input.
