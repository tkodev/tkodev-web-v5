...
- [ ] **m09 — Grain / Background Canvas**
  ...
  - ideas:
    - 2d Dots that assemble into a graphic
    - Topology Lines that form motion
    - 2d Dot graphs that form a 3d mountain
    - ascii characters that form a silhouette
    - isometric 3d scan dot cloud
    - the above with tilt shift blur
