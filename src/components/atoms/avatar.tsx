...
const AvatarFallback = ({
  ...
  return (
    <AvatarPrimitive.Fallback
      className={cn(
        'bg-muted text-muted-foreground font-expressive flex size-full items-center justify-center rounded-full text-sm uppercase',
        className
      )}
...
const AvatarGroupCount = ({ className, ...props }: ComponentProps<'div'>) => {
  return (
    <div
      className={cn(
        'bg-muted text-muted-foreground ring-background relative flex size-10 shrink-0 items-center justify-center rounded-full text-sm ring-2 group-has-data-[size=lg]/avatar-group:size-10 group-has-data-[size=sm]/avatar-group:size-6 [&>svg]:size-4 group-has-data-[size=lg]/avatar-group:[&>svg]:size-5 group-has-data-[size=sm]/avatar-group:[&>svg]:size-3',
        className
      )}
