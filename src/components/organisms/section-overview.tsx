...
type SectionOverviewRef = HTMLDivElement
type SectionOverviewProps = HTMLAttributes<SectionOverviewRef> &
...
const SectionOverview = forwardRef<SectionOverviewRef, SectionOverviewProps>((props, ref) => {
  // props
...
export type { SectionOverviewProps, SectionOverviewRef }
