...
type HomeTestimonialsRef = HTMLDivElement
type HomeTestimonialsProps = HTMLAttributes<HomeTestimonialsRef> &
...
const HomeTestimonials = forwardRef<HomeTestimonialsRef, HomeTestimonialsProps>((props, ref) => {
  // props
...
export type { HomeTestimonialsProps, HomeTestimonialsRef }
