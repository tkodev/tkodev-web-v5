...
type SectionTestimonialsRef = HTMLDivElement
type SectionTestimonialsProps = HTMLAttributes<SectionTestimonialsRef> &
...
const SectionTestimonials = forwardRef<SectionTestimonialsRef, SectionTestimonialsProps>(
  (props, ref) => {
    // props
...
export type { SectionTestimonialsProps, SectionTestimonialsRef }
