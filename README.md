...
Docs drive the implementation, read in numbered order: the rules ([docs/01-standards/](docs/01-standards/)) split by topic, the PRD ([docs/02-prd/](docs/02-prd/)) as a numbered pipeline, then the work state ([docs/03-milestones/](docs/03-milestones/)):
...
| [docs/03-milestones/](docs/03-milestones/) | The milestone graph and per-milestone docs: scope, gates, task cuts with live status |
